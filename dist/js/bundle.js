...
var todo = new _vue2.default({
  el: '#todo',
  data: {
    items: [{ id: 0, text: "サンプルTODOタスク", done: 0, edit: 0 }, { id: 1, text: "サンプルTODOタスク2", done: 1, edit: 0 }],
    nextID: 2,
    searchText: ""
  },
  methods: {
    doAdd: function doAdd() {
      var inputText = this.$refs.text;
    ...
    //タスクの完了
    onDoneItem: function onDoneItem(item) {
    ...
    //タスクtextの変更
    onEditText: function onEditText(item) {
      item.edit = 0;
    },
    //タスクの検索
